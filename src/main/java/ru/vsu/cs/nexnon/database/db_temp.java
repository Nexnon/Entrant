...
public class db_temp {
    ...
    public static List<Direction> directionList = Arrays.asList(
            new Direction("Информационная безопасность", 5),
            new Direction("Прикладная информатика", 5),
            new Direction("Информационные системы и технологии", 5)
            );
